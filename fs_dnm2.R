...
dnm2 <- ggplot(acc) + geom_point(aes(x = val3, y = Accuracy, color = subj)) +
    geom_line(mapping = aes(x = val3, y = pred, color = subj)) + ylim(0.49, 0.9) + xlab("Dud stimulus") + ggtitle("dnm2")  + guides(color = guide_legend(title = NULL))
dnm2
...
ggplot(conf_dat) + geom_line(aes(x = condition, y = mean_be, color = subj)) + 
    ...
    facet_grid(. ~ max) + ggtitle("dnm2") -> dnm2_be
dnm2_be
...
ggplot(conf_dat) + geom_line(aes(x = condition, y = mean_be2, color = subj)) + 
    ...
    facet_grid(. ~ max) + ggtitle("dnm2") -> dnm2_be2
dnm2_be2
...
ggplot(conf_dat) + geom_line(aes(x = condition, y = mean_dce, color = subj)) + 
    ...
    facet_grid(. ~ max) + ggtitle("dnm2") -> dnm2_dce
dnm2_dce